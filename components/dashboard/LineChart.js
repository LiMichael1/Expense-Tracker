        ...
        <div className='w-full h-fit mt-4 mb-12 border rounded-md px-3 py-2'>
            ...
            <div className='w-full flex justify-between'>
                ...
                <div className='flex justify-between gap-x-6'>
                    ...
                    {/* Timeframe picker */}
                    <button id='timeframeButton' className='bg-gray-300 rounded flex items-center gap-x-2 px-2 py-1'>
                        <label htmlFor='timeframeButton' className='pointer-events-none text-sm'>Last 7 Days</label>
